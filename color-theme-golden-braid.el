...
(defun color-theme-golden-braid ()
  ...
  (color-theme-install
   '(color-theme-golden-braid
     ...
     (escape-glyph ((t (:foreground "gray35"))))
     ...
     (font-lock-doc-face ((t (:foreground "gray60" :background "gray16"))))
     (font-lock-doc-string-face ((t (:background "gray16" :foreground "slate gray"))))
     ...
     (org-level-2 ((t (:foreground "gold3"))))
     (org-level-3 ((t (:foreground "darkgoldenrod"))))
     ...
     (proof-locked-face ((t (:background "#333366"))))
     ...
     (scion-warning-face ((t (:background "#653"))))
     ...
     (sh-quoted-exec ((t (:foreground "OliveDrab3"))))
     (shadow ((t (nil))))
