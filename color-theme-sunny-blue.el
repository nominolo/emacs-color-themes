...
(defun color-theme-sunny-blue ()
  "Color theme by nominolo, created 2010-02-01."
  (interactive)
  (color-theme-install
   '(color-theme-sunny-blue
     ...
     (dired-directory ((t (:bold t :foreground "RoyalBlue4" :background "lightsteelblue1" :weight bold))))
     ...
     (font-lock-doc-face ((t (:foreground "gray40" :background "grey92"))))
     (font-lock-doc-string-face ((t (:foreground "gray40" :background "grey90"))))
     (font-lock-exit-face ((t (:foreground "red"))))
     (font-lock-function-name-face ((t (:background "lightsteelblue1" :foreground "RoyalBlue4"))))
...
;;      (font-lock-string-face ((t (:background "gray90" :foreground "tan4"))))
     ...
     (font-lock-type-face ((t (:foreground "red3"))))
     (font-lock-variable-name-face ((t (:foreground "orange3"))))
...
(add-to-list 'color-themes '(color-theme-sunny-blue  "Sunny Blue" "nominolo"))
